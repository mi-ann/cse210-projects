...
public class ScriptureLibrary
{
    ...
    {
        _scriptures = InitializeScriptureLibrary();
    }

    private List<Scripture> InitializeScriptureLibrary()
    {
    ...
    public Scripture GetRandomScripture()
    {
        ...
        int index = rand.Next(_scriptures.Count); // Get a random index
        return _scriptures[index]; // Return the scripture at that index
    }
}